...
$('#mySelect').change(function() {
	...
	if(select_value == 1) {
		...
		var select1 = new Array(
			"校区云平台<br/>(科技网/研究院)", "慕课平台<br/>(仪电鑫森)", "校园照明与安防<br/>(飞乐/云赛智联)", "安全教室<br/>(仪电鑫森)", "校区一卡通<br/>(仪电物联)",
			"校园公广系统<br/>(赛嘉)", "校区水质<br/>(科学仪器/云瀚)", "能耗管理系统<br/>(仪电物联)", "校区停车<br/>(云赛智联)", "云应用<br/>(南洋万邦)",
			"容灾备份<br/>(科技网/研究院)", "电子教室", "校园食安管理<br/>(溯源科技)", "智慧图书系统", "远程桌面<br/>(赛维)"
		);
		for(var x = 1; x <= 15; x++) {
...
//		$(".desktop-two-button").addClass("white_bd1");
		...
		var select2 = new Array(
			...
			"项目验收管理", "组织机构系统", "园区照明与安防<br/>(飞乐/云赛智联)", "人脸识别系统<br/>(云智科技)", "远程桌面<br/>(赛维)"
		);
		for(var x = 1; x <= 15; x++) {
