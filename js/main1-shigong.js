...
$('#mySelect').change(function() {
	...
	if(select_value == 1) {
		...
		var select1 = new Array(
			"施工管理", "预算管理", "照明系统<br/>", "安防监控<br/>", "停车管理<br/>",
			"公广系统<br/>", "工地噪音管理", "升降机监控管理", "整改与罚款", "通讯录管理",
			"数据中心", "安全教育管理", "项目管理", "能耗管理<br/>", "智能识别<br/>"
		);
		for(var x = 1; x <= 15; x++) {
...
//		$(".desktop-two-button").addClass("white_bd1");
		var select2 = new Array(
			"施工管理", "地块信息系统", "照明系统<br/>", "安防监控<br/>", "停车管理<br/>",
			"公广系统<br/>", "工地噪音管理", "升降机监控管理", "整改与罚款", "物业管理",
			"数据中心", "安全教育管理", "土地开发监控", "能耗管理<br/>", "智能识别<br/>"
		);
		for(var x = 1; x <= 15; x++) {
		...
		$('.desktop-two-button').attr("disabled", "disabled");
		var select2 = new Array(
			"施工管理<br/>", "预算管理<br/>", "照明系统<br/>", "安防监控<br/>", "停车管理<br/>",
			"公广系统<br/>", "工地噪音管理<br/>", "升降机监控管理<br/>", "整改与罚款<br/>", "通讯录管理<br/>",
			"数据中心<br/>", "安全教育管理<br/>", "项目管理<br/>", "能耗管理<br/>", "智能识别<br/>"
		);
		for(var x = 1; x <= 15; x++) {
			$("#leap" + x).children().next().html(select2[x - 1]+"33");
		}
	} else {}
})
