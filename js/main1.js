...
$('#mySelect').change(function() {
	...
	if(select_value == 1) {
		...
		var select1 = new Array(
			...
			"电子教室", "校区水质<br/>(科学仪器/云瀚)", "能耗管理系统<br/>(物联)", "校区停车<br/>(云赛智联)", "云应用<br/>(南洋万邦)",
		...
		var select2 = new Array(
			...
			"电子教室2", "校区水质<br/>(科学仪器/云瀚)2", "能耗管理系统<br/>(物联)2", "校区停车<br/>(云赛智联)2", "云应用<br/>(南洋万邦)2",
		...
		var select2 = new Array(
			...
			"电子教室3", "校区水质<br/>(科学仪器/云瀚)3", "能耗管理系统<br/>(物联)3", "校区停车<br/>(云赛智联)3", "云应用<br/>(南洋万邦)3",
